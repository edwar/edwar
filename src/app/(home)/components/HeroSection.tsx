        ...
        <div className='min-h-[60vh] flex flex-col-reverse gap-5 lg:gap-0 lg:flex-row items-center justify-between'>
                ...
                <div className='relative group'>
                    <div className='w-72 h-[25rem] space-x-3 relative'>
                        <Image layout="responsive" priority quality={75} width={288} height={401} src="/profile.webp" alt="Edwar Amaya" className='filter drop-shadow-3xl gradient-mask-b-70 md:group-hover:scale-110 md:group-hover:-translate-y-10 md:transition-all md:duration-1000' />
                    </div>
