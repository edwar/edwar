...
export default function KeyboardManager() {
  ...
  return (
    <>
      ...
      <div role="none" onClick={() => setOpen(true)} className="no-print fixed inset-0 py-4 h-14 w-28 cursor-pointer inline-flex lg:hidden gap-1 left-1/2 -translate-x-1/2">
